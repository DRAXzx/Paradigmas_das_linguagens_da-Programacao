...
public class Main{
    public static void main(String[] args) {
        ...
        int numeroDeThreads = 4; // Ajuste conforme necessidade
...
//Por outro lado, o algoritmo paralelo é como ter várias pessoas trabalhando em uma
// tarefa ao mesmo tempo. Para grandes volumes de dados, como as 80 mil linhas que você mencionou, ele divide o trabalho
// entre várias threads, aproveitando múltiplos núcleos do processador. Isso faz com que o processamento seja muito mais
// rápido. Portanto, se você está lidando com um grande número de linhas, o paralelismo é definitivamente
// o caminho a seguir, já que pode reduzir significativamente o tempo que você levaria para concluir a tarefa.